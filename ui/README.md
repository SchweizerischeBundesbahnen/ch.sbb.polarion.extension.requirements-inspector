...
`/polarion/requirements-inspector-app/ui/app/`. The Maven build (frontend-maven-plugin +
maven-resources-plugin) runs this automatically and copies the bundle into
`src/main/resources/webapp/requirements-inspector-app/app`, where `RequirementsInspectorAppServlet` serves it at
`/polarion/requirements-inspector-app/ui/app/index.html`.
