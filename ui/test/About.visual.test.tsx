    ...
    installFetchMock([
      {
        ...
        match: /\/version$/,
        json: {
          bundleName: 'Requirements Inspector',
          bundleVendor: 'SBB',
          supportEmail: 'polarion-opensource@sbb.ch',
          automaticModuleName: 'ch.sbb.polarion.extension.requirements_inspector',
          bundleVersion: '1.0.0',
      ...
      },
      {
        ...
        json: {
          properties: [
            {
              key: 'ch.sbb.polarion.extension.requirements-inspector.some.property',
              value: 'value',
              defaultValue: 'value',
      ...
      },
      {
        ...
        json: [{ name: 'Requirements Inspector', status: 'OK', details: 'ready' }],
      },
      {
        method: 'GET',
        match: /\/readme$/,
        respond: () =>
          new Response(
            '<h1>Requirements Inspector Extension for Polarion ALM</h1><p>Synchronises users and groups from Azure AD.</p>',
            { status: 200 },
          ),
      },
    ]);
