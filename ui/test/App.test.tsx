...
const aboutRoutes = () => [
  {
    method: 'GET',
    match: /\/version$/,
    json: { bundleName: 'Requirements Inspector', bundleVendor: 'SBB', bundleVersion: '1.0.0' },
  },
...
afterEach(() => {
  ...
  document.cookie = 'requirements-inspector-dev-scope=; path=/; max-age=0';
});
...
describe('App router', () => {
  ...
  it('renders the About page for ?feature=about', async () => {
    ...
    expect(document.body.textContent).toContain('Requirements Inspector');
